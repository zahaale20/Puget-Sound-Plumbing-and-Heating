            ...
            >
                <div className="flex flex-col max-w-7xl mx-auto px-6 w-full gap-6 text-white text-center md:text-left">
                    ...
                    <p className="leading-relaxed">
                        {serviceDescription || `Professional ${serviceName.toLowerCase()} solutions for homeowners throughout the Greater Seattle area.`}
                    </p>
                </div>
            </section>
                    ...
                    <div className="relative flex flex-col gap-6 w-full z-10">
                        ...
                        <ul className="space-y-6 text-[#2B2B2B]">
                            {problems.length > 0 ? problems.map((problem, index) => (
                                ...
                                <li className="italic text-gray-400">Contact us for a professional diagnostic if your system is underperforming.</li>
                            )}
                        </ul>
                    </div>
            ...
            >
                <div className="relative flex flex-col max-w-7xl mx-auto px-6 gap-6 w-full z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            { step: "1", title: "Contact Us", desc: `Call ${phone}. Our dispatch team will assess your situation.` },
                            { step: "2", title: "Rapid Response", desc: "A licensed professional will arrive equipped with the right tools." },
                            { step: "3", title: "Diagnosis", desc: "The expert will explain the issue and provide a quote before work starts." },
                            { step: "4", title: "Repair & Cleanup", desc: "The technician will perform the repairs and clean up the work area." }
                        ].map((item, i) => (
                            <div key={i} className="flex flex-col gap-3 p-4 text-[#2B2B2B]">
                                <h5 className="font-bold">{item.step}. {item.title}</h5>
            ...
            <section className="w-full py-16 bg-[#F5F5F5]">
                <div className="relative max-w-7xl mx-auto px-6 z-10 space-y-6">
                    ...
                    <div className="flex flex-col gap-6 text-[#2B2B2B] leading-relaxed pb-2">
                        <p>
                            {serviceName} situations require immediate, expert intervention. Attempting DIY repairs can worsen the damage and lead to code violations.
                        </p>
                    </div>
                        ...
                        <table className="w-full text-left border-collapse bg-white min-w-[800px] table-fixed">
                            ...
                            <tbody className="text-[#2B2B2B]">
                                <tr className="border-b border-gray-100">
                                    ...
                                    <td className="p-5 font-medium">Rapid dispatch with fully equipped mobile units</td>
                                </tr>
                                <tr className="border-b border-gray-100">
                                    ...
                                    <td className="p-5 font-medium">Root-cause identification via advanced telemetry</td>
                                </tr>
                                <tr className="border-b border-gray-100">
                                ...
                                <tr className="border-b border-gray-100">
                                    ...
                                    <td className="p-5 font-medium">100% compliant with local Seattle plumbing codes</td>
                                </tr>
                                <tr className="border-b border-gray-100">
                                    ...
                                    <td className="p-5 font-medium">Permanent solutions with industrial-grade components</td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="p-5 font-medium">Full commercial insurance & workmanship warranty</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
