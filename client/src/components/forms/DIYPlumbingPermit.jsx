					...
					{submitSuccess ? (
						...
						<>
							...
							<button
								...
								className="flex items-center justify-center w-full sm:w-auto sm:min-w-[220px] h-[50px] px-8 gap-2 text-base font-semibold text-white cursor-pointer transition-all duration-300 transform whitespace-nowrap bg-[#B32020] hover:bg-[#7a1515] disabled:opacity-60 disabled:cursor-not-allowed"
							>
