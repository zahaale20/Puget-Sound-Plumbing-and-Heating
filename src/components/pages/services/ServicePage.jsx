...
export default function ServicePage() {
	...
	const category = ServiceLinks.find(
		(item) =>
			item.name.replace(/\s+/g, "-").toLowerCase() === categorySlug
	);
		...
		<div className="mt-[101px] md:mt-[106px] lg:mt-[167px]">
			...
			>
				<div className="flex flex-col max-w-7xl mx-auto px-6 w-full gap-6 text-white">
					...
					<p>
						Puget Sound Plumbing & Heating provides professional {serviceName.toLowerCase()} services across the Seattle region. Our licensed technicians diagnose problems quickly and deliver dependable solutions that restore safety, comfort, and efficiency to your home.
					</p>
			...
			<section className="flex justify-center w-full py-16">
				<div className="flex flex-col max-w-7xl mx-auto px-6 w-full gap-6">
					...
					<p className="text-[#2B2B2B]">
						When it comes to {serviceName.toLowerCase()}, there are common problems that homeowners often encounter. These issues can range from minor inconveniences to major disruptions that affect the comfort and safety of your home. Some of the most frequently reported problems include:
					</p>
			...
			<section className="flex justify-center w-full py-16 bg-[#F5F5F5]">
				<div className="flex flex-col max-w-7xl mx-auto px-6 w-full gap-6">
					...
					<p className="text-[#2B2B2B]">
						When it comes to {serviceName.toLowerCase()} services, you want a team you can trust to get the job done right the first time. Here's why homeowners across the Seattle region choose Puget Sound Plumbing & Heating for their plumbing and heating needs:
					</p>
